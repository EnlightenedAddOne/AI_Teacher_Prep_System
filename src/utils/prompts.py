...
teaching_design_prompt = PromptTemplate(
    ...
    请根据以下步骤为教师生成一份详细的教学设计方案,确保教学设计清晰、全面，符合教学目标，并且能够激发学生兴趣，提高课堂参与度。输出不应包含任何XML标签。一级标号从"学科名称"开始。输出的一级标题的标号为1、2、3，二级标题的标号为(1)、(2)、(3)，三级标题的标号为1)、2)、3),输出格式为markdown格式。
